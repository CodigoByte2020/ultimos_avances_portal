...
class CustomerPortal(CustomerPortal):
    ...
    def document_form_view(self, **kwargs):
        '''
            Update documents of the partner.
            :param kwargs: Arguments to update the document.
            :type kwargs: Dictionary.
            :return: A string that represents the url to be redirected.
            :rtype: str
        '''
        ...
        values = {
            ...
            'res_partner_document_ids': current_user.partner_id.res_partner_document_ids
        }
        if request.httprequest.method == 'GET':
            ...
            try:
                for document in documents_to_update:
                    ...
                    if decoded_file:
                        res_partner_document = request.env['res.partner.document'].sudo().browse(
                            document['document_id'])
                        res_partner_document.write({
                            'file': decoded_file,
